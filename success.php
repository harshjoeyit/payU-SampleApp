...
//Please use(verify) the amount value from database
$amount = $_POST["amount"];
$txnid = $_POST["txnid"];
...
echo "<br /> POSTED HASH ".$posted_hash;

if ($reverse_hash != $posted_hash) {
	echo "<br />Hash Match Fail (success.php). Transaction has been tampered. Please try again";
}
